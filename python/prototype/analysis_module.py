...
""" This module is an analysis module of the Json file generated from TRACE COMPARE
"""
#pprint(data)
...
class trace_analysis:
    ...
    #This function writes a csv using a dictionary - the 4 groups of SVM
    ...
    #This function writes a csv using the information of the json, basically csv of a, b and e metrics
    def write_groups_in_csv(self,file,info):
        print info
        with open(file, 'wb') as testfile:
            csv_writer = csv.writer(testfile)
            ...
            csv_writer.writerow(list_a)
            csv_writer.writerow(list_b)
            csv_writer.writerow(list_e)
